# BundleWithSingleExaminationAndAI-Example - RetinaIntegration v0.1.2
...
* **Code**: [Fundusfotagrafi](Bundle-BundleWithSinglExamination-Example.md#Observation_ObservationPhoto-1)
  * **Value**: true
  * **Flags**: Final
  * **When For**: 
* **Code**: [OCT tatt](Bundle-BundleWithSinglExamination-Example.md#Observation_ObservationOCT-1)
  * **Value**: true
  * **Flags**: Final
  * **When For**: 
...
**identifier**:[RetinaObservationIdentifierSystem](NamingSystem-retina-observation-id.md)/eb8ef81c-d8a5-4656-b44d-2f9b86a16903**status**: Final**code**:Fundusfotagrafi**value**: true
...
**identifier**:[RetinaObservationIdentifierSystem](NamingSystem-retina-observation-id.md)/96f8e5bb-41be-4dae-bcc3-833b01b050ab**status**: Final**code**:OCT tatt**value**: true

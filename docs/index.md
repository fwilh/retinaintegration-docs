...
```json
{
  ...
  "description" : "RetinaIntegration integrates DIPS EyeCare-Retinopathy with external AI system",
  "packageId" : "dips.fhir.retinaintegration",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [
    {
  ...
  "definition" : {
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://ehelse.no/fhir/CodeSystem/no-kodeverk-8660"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://dips.no/fhir/RetinaIntegration/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
    ...
    "resource" : [
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CapabilityStatement/DIPSRetinaCapabilityStatement"
        },
        "name" : "DIPSRetinaCapabilityStatement",
      ...
      },
      {
        ...
        "name" : "Kodeverk for konklusjon Retina",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "Parameters/PegaOperation"
        },
        "name" : "PegaOperation",
        "description" : "Example request from Pega to append AI results to existing DiagnosticReport",
        "exampleBoolean" : true
      },
      {
        "extension" : [
      ...
      },
      {
        ...
        "name" : "Verdisett for videre forløp Retinascreening",
